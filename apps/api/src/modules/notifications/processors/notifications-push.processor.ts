...
/** Worker da fila `notifications-push` — ver `NotificationDeliveryRunnerService` para a lógica compartilhada. */
@Processor(QUEUE_NAMES.NOTIFICATIONS_PUSH)
export class NotificationsPushProcessor extends WorkerHost {
