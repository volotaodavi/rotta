...
/** Worker da fila `notifications-sms` — ver `NotificationDeliveryRunnerService` para a lógica compartilhada. */
@Processor(QUEUE_NAMES.NOTIFICATIONS_SMS)
export class NotificationsSmsProcessor extends WorkerHost {
