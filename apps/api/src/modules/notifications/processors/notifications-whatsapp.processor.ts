...
/** Worker da fila `notifications-whatsapp` — ver `NotificationDeliveryRunnerService` para a lógica compartilhada. */
@Processor(QUEUE_NAMES.NOTIFICATIONS_WHATSAPP)
export class NotificationsWhatsappProcessor extends WorkerHost {
