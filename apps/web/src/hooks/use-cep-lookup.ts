 ...
 * API, usado apenas para acelerar o formulário de cadastro de Empresa
 * (o mais longo do fluxo self-service — 7 campos de endereço, antes
 * todos manuais). Nunca bloqueia o cadastro: se o CEP não existir na
 * base do ViaCEP ou o serviço estiver fora do ar, os campos continuam
 * editáveis manualmente — só não são pré-preenchidos.
 */
