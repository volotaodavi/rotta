  ...
  return (
    ...
    >
      ...
      <LegalSection id="o-que-e" title="3. O que a Rotta é e o que ela não é">
        A Rotta é uma plataforma de intermediação e gestão: ela conecta famílias a transportadores e
        fornece as ferramentas operacionais, mas <strong>não é</strong> ela própria a
        ...
        regularidade ou cumprimento de todas as obrigações legais aplicáveis. Veja{" "}
      ...
      <LegalSection id="documentos" title="8. Documentos">
        ...
        enviados à plataforma para verificação: esses arquivos ficam em armazenamento privado, nunca
        em URL pública (ver <Link href="/legal/seguranca">Segurança na Rotta</Link>). Contratos
        gerados na plataforma (quando houver assinatura eletrônica) seguem o fluxo descrito em{" "}
      ...
      <LegalSection id="cobranca" title="10. Cobrança">
        ...
        Responsável (família) é gratuito: a Rotta nunca cobra da família pelo acesso à plataforma; o
        pagamento do transporte em si (quando houver) é acordado diretamente com a transportadora,
      ...
      >
        ...
        <Link href="/legal/comunidade">Política da Comunidade</Link>, sempre que possível com aviso
        prévio, exceto em casos de fraude, risco à segurança de outros usuários ou exigência legal,
        quando a suspensão pode ser imediata. Dados sujeitos a obrigação legal de retenção (ex.
        registros fiscais, logs de auditoria de segurança) podem ser mantidos mesmo após o
