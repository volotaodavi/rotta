  ...
  return (
    ...
    >
      ...
      <LegalSection id="partes" title="2. Quem contrata, quem presta, quem paga">
        ...
        <strong>entre a família (responsável) e a transportadora escolhida</strong> — a Rotta
        fornece a infraestrutura tecnológica (busca, comunicação, geração de contrato, cobrança
        recorrente quando configurada), mas não é ela própria a transportadora nem parte do contrato
        de transporte. O pagamento do serviço de transporte é acordado entre as partes e processado
