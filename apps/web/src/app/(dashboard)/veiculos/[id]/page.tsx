...
export default function VeiculoDetalhePage({
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {activeTab === "dados" && <DadosTab vehicleId={id} />}
      {activeTab === "documentos" && <DocumentosTab vehicleId={id} />}
      {activeTab === "manutencoes" && <ManutencoesTab vehicleId={id} />}
      {activeTab === "lembretes" && <LembretesTab vehicleId={id} />}
      {activeTab === "vinculos" && <VinculosTab vehicleId={id} />}
      {activeTab === "checklist" && <ChecklistTab vehicleId={id} />}
      {activeTab === "ocorrencias" && <OcorrenciasTab vehicleId={id} />}
      {activeTab === "auditoria" && <AuditoriaTab vehicleId={id} />}
    </div>
  );
}
