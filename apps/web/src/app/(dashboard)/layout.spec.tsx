...
describe("DashboardLayout: guard de rota do Modo Ação", () => {
   ...
   * 'perfil'"): os atalhos de `ATALHOS_PERFIL` (Notificações/Chamados/
   * Verificar identidade/Documentação) linkavam pra rotas fora do
   * allowlist do guard acima — o clique navegava e era imediatamente
