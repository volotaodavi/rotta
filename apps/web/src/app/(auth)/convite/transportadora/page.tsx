 ...
 *
 * Rota estática pública nova, irmã de `/convite` (o "código de convite"
 * de equipe é outro conceito — `Invite`, um código de uso único gerado
 * pela empresa pra UMA pessoa; aqui é `Company.codigoInterno`, o código
 * público permanente da transportadora, o mesmo já usado em
 * `/vincular-transporte` e no Marketplace). Nunca cria uma conta sem
 * senha: o cadastro tradicional (`/criar-conta`) continua existindo
 * exatamente como está — este é só um segundo caminho, mais rápido,
 * pra quem já tem o código em mãos.
 *
