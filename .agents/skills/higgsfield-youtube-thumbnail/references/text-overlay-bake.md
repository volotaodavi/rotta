...
```css
.line {
  -webkit-text-stroke: 14px #1a0a00;
  paint-order: stroke fill;
  background: linear-gradient(#ffe24b 0%, #ff9a1f 45%, #ff2e2e 100%);
  -webkit-background-clip: text;
  background-clip: text;
  color: transparent;
  filter: drop-shadow(0 0 22px rgba(255, 120, 0, 0.55)) drop-shadow(0 10px 0 rgba(0, 0, 0, 0.4));
}
```
...
.line {
  color: #d4ff3f;
  -webkit-text-stroke: 12px #0a1400;
  paint-order: stroke fill;
  text-shadow:
    0 0 26px rgba(180, 255, 40, 0.7),
