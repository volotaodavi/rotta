 ...
 * auditoria minuciosa 04/09/2026: como `@rotta/maps` é um pacote com seu
 * próprio `tsc --noEmit` isolado (não herda o `global.d.ts` de nenhum
 * app consumidor), faltava esta mesma cópia aqui — `pnpm turbo run
 * typecheck` falhava de verdade (`Cannot find namespace 'JSX'` em
 * `native/index.tsx` e `web/index.tsx`), quebraria o CI no próximo PR
 * que tocasse este pacote.
 */
declare global {
  namespace JSX {
